...
export default function NgoReg() {
    ...
    const sendData = (e) => {
        ...
        fetch("https://localhost:7031/api/Registration/saveNgo", reqdata)
            .then(resp => {
                if (!resp.ok) {
    ...
    return (
        <div className="registration-page" style={{ 
            ...
            <div className="registration-card card shadow-lg p-4 mb-5 bg-white rounded" style={{ 
                ...
                <h1 className="text-center mb-4" style={{ color: '#4e73df', fontWeight: 'bold' }}>NGO Registration</h1>
                    ...
                    <form onSubmit={sendData}>
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input
                                ...
                                name="ngoName"
                                value={info.ngoName}
                                onChange={(e) => dispatch({ type: 'update', fld: 'ngoName', val: e.target.value })}
                                required
                            />
                        </div>
                        <div className="form-group mb-3">
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input
                                ...
                                name="owner"
                                value={info.owner}
                                onChange={(e) => dispatch({ type: 'update', fld: 'owner', val: e.target.value })}
                                required
                            />
                        </div>
                        <div className="form-group mb-3">
